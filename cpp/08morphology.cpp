...
void open(){
    ...
    auto kernel = cv::getStructuringElement(cv::MORPH_RECT, {5, 5}, {-1, -1});
    cv::morphologyEx(src, dst, cv::MORPH_OPEN, kernel, {-1, -1}, 1);

    cv::imshow("open src", src);
...
void close(){
    ...
    //auto kernel = cv::getStructuringElement(cv::MORPH_RECT, cv::Size(5, 5), cv::Point(-1, -1));
    auto kernel = cv::getStructuringElement(cv::MORPH_RECT, {5, 5}, {-1, -1});
    cv::morphologyEx(src, dst, cv::MORPH_CLOSE, kernel, {-1, -1}, 1);

    cv::imshow("close src", src);
...
void gradient(){
    ...
    //auto kernel = cv::getStructuringElement(cv::MORPH_RECT, cv::Size(5, 5), cv::Point(-1, -1));
    auto kernel = cv::getStructuringElement(cv::MORPH_RECT, {5, 5}, {-1, -1});
    cv::morphologyEx(src, dst, cv::MORPH_GRADIENT, kernel, {-1, -1}, 1);

    cv::imshow("gradient src", src);
...
void topHat(){
    ...
    //auto kernel = cv::getStructuringElement(cv::MORPH_RECT, cv::Size(5, 5), cv::Point(-1, -1));
    auto kernel = cv::getStructuringElement(cv::MORPH_RECT, {5, 5}, {-1, -1});
    cv::morphologyEx(src, dst, cv::MORPH_TOPHAT, kernel, {-1, -1}, 1);

    cv::imshow("top hat src", src);
...
void blackHat(){
    ...
    //auto kernel = cv::getStructuringElement(cv::MORPH_RECT, cv::Size(5, 5), cv::Point(-1, -1));
    auto kernel = cv::getStructuringElement(cv::MORPH_RECT, {5, 5}, {-1, -1});
    cv::morphologyEx(src, dst, cv::MORPH_BLACKHAT, kernel, {-1, -1}, 1);

    cv::imshow("black hat src", src);
